...
const TableHeader = ({ onSort, selectedSort, columns }) => {
    ...
    // const sortIcon = (columns, column) => {
    //     if (columns[column].path) {
    //         return handleSort(columns[column].path)
    //     }
    //     return undefined
    // }
    ...
    // const iconClasses = selectedSort => selectedSort.order === 'asc'
    ...
    return (<thead>
        <tr>
            {Object.keys(columns).map(column => (
                <th key={column}
                    // onClick={() => sortIcon(columns, column)}
                ...
                >
                    ...
                    ? <i className={iconClasses(selectedSort)}></i>
                    : null} */ }
                </th>
            ))}
